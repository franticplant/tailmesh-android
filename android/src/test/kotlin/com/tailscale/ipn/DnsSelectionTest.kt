...
class DnsSelectionTest {
  ...
  fun testFirstDnsSelected() {
    val servers = listOf(InetAddress.getByName("8.8.8.8"), InetAddress.getByName("8.8.4.4"))
  ...
  fun testIPv6DnsSelected() {
    ...
    // InetAddress.hostAddress returns the uncompressed string representation or exactly what was
    // passed.
